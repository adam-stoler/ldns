							 ...
							 ldns_rdf **prev, bool question)
{
	...
	for (done = false, r_cnt = 0; !done && r_cnt < r_max; r_cnt++) {
		...
		case LDNS_RDF_TYPE_SVCBPARAMS : if (r_cnt == r_max - 1) {
							delimiters = "\n";
							break;
						}
						/* fallthrough */
...
static const ldns_rdf_type type_svcb_wireformat[] = {
	LDNS_RDF_TYPE_INT16, LDNS_RDF_TYPE_DNAME, LDNS_RDF_TYPE_SVCBPARAMS
};
...
{LDNS_RR_TYPE_SVCB, "HTTPS", 2, 3, type_svcb_wireformat, LDNS_RDF_TYPE_NONE, LDNS_RR_NO_COMPRESS, 0 },
